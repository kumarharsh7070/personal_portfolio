...
class _AdminPageState extends State<AdminPage> {
  ...
  Future<void> generateAndDownloadPDF() async {
    if (await Permission.storage.request().isGranted ||
                ...
                ...snapshot.docs.map((doc) {
                  ...
                  return pw.Column(
                    ...
                    children: [
                      ...
                      pw.Text("District: ${data['district'] ?? 'N/A'}"),
                      pw.Text("Phone: ${data['phone'] ?? 'N/A'}"),
                      pw.Text("Ward: ${data['ward'] ?? 'N/A'}"),
                      pw.Text("Message: ${data['message'] ?? 'N/A'}"),
                      pw.Text(
      ...
      final filePath = "${directory.path}/Contact_Form_Data.pdf";

      final file = File(filePath);
      await file.writeAsBytes(await pdf.save());

      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text("Download Complete! PDF saved at: $filePath")),
      );
    } else {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
...
Future<String> getDownloadPath() async {
  ...
  String path = '${dir!.path}/Download/Contact_Form_Data.pdf';
  return path;
}
